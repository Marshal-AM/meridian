    ...
    const events = [
      {
        CreatedEvent: {
          contractId: "cid-1",
          templateId: "#com-meridian-receivable-v3:Meridian.Receivable.Receivable:Receivable",
    ...
    const events = [
      {
        CreatedEvent: {
          contractId: "cid-2",
          templateId: "#com-meridian-receivable-v3:Meridian.Receivable.ReceivableProposal:ReceivableProposal",
    ...
    const events = [
      {
        CreatedEvent: {
          contractId: "req-1",
          templateId:
            "#com-meridian-receivable-v3:Meridian.Financing.FinancingRequest:FinancingRequest",
          createArgument: {
            requestId: "ROUND-1",
    ...
    const events = [
      {
        CreatedEvent: {
          contractId: "bid-1",
          templateId: "#com-meridian-receivable-v3:Meridian.Financing.Bid:Bid",
          createArgument: {
            requestId: "ROUND-1",
            financier: "fin-a::abc",
          },
