/**
 * Full Phase 2 stack smoke: portal-api + indexers + notifications + financing round.
 * Spawns services, exercises the Phase 1 HTTP flow, then completes an oracle-anchored
 * financing round on-ledger and re-verifies interface-view privacy.
 */
...
async function startStack(): Promise<void> {
  console.log("Starting Phase 2 stack services...");
